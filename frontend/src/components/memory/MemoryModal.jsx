        ...
        <div style={{ padding: '20px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '14px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <>
                  <button
                    ...
                    style={{
                      ...
                      color: '#C9A84C', borderRadius: '5px', padding: '3px 8px',
              ...
              <button
                onClick={onClose}
                style={{ background: 'none', border: 'none', color: '#6B7280', cursor: 'pointer', fontSize: '18px', padding: '2px', lineHeight: 1 }}
              >×</button>
            </div>
          </div>
          ...
          {confirmDelete && (
            <div style={{
              ...
              borderRadius: '8px', padding: '14px', marginBottom: '14px', textAlign: 'center',
            }}>
              ...
              <div style={{ display: 'flex', gap: '8px', justifyContent: 'center' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '6px', padding: '6px 16px', cursor: deleting ? 'wait' : 'pointer',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                ...
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                  {YEAR_OPTIONS.map(opt => (
                    <button
                      key={opt.value}
                      type="button"
                      onClick={() => setEditYear(opt.value)}
                      style={{
                        background: editYear === opt.value ? opt.color : 'transparent',
                        border: `1px solid ${opt.color}`,
                        color: editYear === opt.value ? opt.textColor : opt.color,
                        borderRadius: '999px', padding: '4px 14px', cursor: 'pointer',
              ...
              <textarea
                ...
                style={{
                  ...
                  borderRadius: '8px', padding: '12px', color: '#E5E7EB',
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        width: '64px', height: '80px', flexShrink: 0, cursor: 'zoom-in',
                      }}
                    >
                      <img
                        src={`${apiBase}${editPhotoUrl}`}
                        alt="Memory photo"
                  ...
                  <>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: '6px', padding: '8px 16px', cursor: uploading ? 'wait' : 'pointer',
                        color: '#9CA3AF', fontSize: '13px', fontFamily: "'DM Sans', sans-serif",
                      }}
              ...
              <div style={{ display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
                ...
                <button
                  ...
                  style={{
                    background: saving ? '#4B5563' : 'linear-gradient(135deg, #C9A84C, #E8C56A)',
                    border: 'none', color: '#0A0E1A', borderRadius: '6px',
            ...
            <>
              {memory.photo_url && (
                <div style={{
                  ...
                  borderRadius: '6px', overflow: 'hidden', marginBottom: '14px', background: '#1F2937',
                }}>
                  <img
              ...
              {memory.memory_text && (
                <p style={{
                  fontSize: '15px', color: '#E5E7EB', fontFamily: "'DM Sans', sans-serif",
      ...
      {photoExpanded && (
        <div
          ...
          style={{
            ...
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            zIndex: 200, cursor: 'zoom-out', padding: '24px',
          }}
        >
          <img
            src={`${apiBase}${editPhotoUrl}`}
